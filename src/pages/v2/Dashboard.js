                        ...
                        <table className="overflow-y-scroll  ">
                            ...
                            <tbody className="bg-white cursor-pointer ">
                                ...
                                <tr className="hover:bg-gray-100 ">
                                    ...
                                    <td className="py-4 text-sm font-medium text-gray-400 whitespace-nowrap ">(deleted)</td>
                                    <td className="py-4 text-sm font-medium text-gray-400 whitespace-nowrap ">xxx@xxx.xxx</td>
                                    <td className="py-4 text-sm font-medium text-gray-400 whitespace-nowrap ">Customer</td>
                                    <td className="py-4 text-sm font-medium text-gray-400 whitespace-nowrap ">31/05/2022 08:02</td>
                                    <td className="py-4 text-sm font-medium text-gray-400 whitespace-nowrap "><span className='flex items-center justify-center text-red-800 bg-red-100 w-fit px-2 py-1 text-xs rounded-full'>Deleted</span></td>
                                    <td className="py-4 text-sm font-medium text-right whitespace-nowrap">
                                        <div className="text-gray-400 hover:scale-110 transition-all duration-200 ease-in-out">
                                            <BsThreeDots size={20} />
                                        </div>
                                ...
                                <tr className="hover:bg-gray-100 ">
                                    ...
                                    <td className="py-4 text-sm font-medium text-gray-400 whitespace-nowrap ">Pascal Zhou</td>
                                    <td className="py-4 text-sm font-medium text-gray-400 whitespace-nowrap ">pascal@easyscooter.com</td>
                                    <td className="py-4 text-sm font-medium text-gray-400 whitespace-nowrap ">Partner</td>
                                    <td className="py-4 text-sm font-medium text-gray-400 whitespace-nowrap ">06/06/2022 2:22</td>
                                    <td className="py-4 text-sm font-medium text-gray-400 whitespace-nowrap ">
                                ...
                                <tr className="hover:bg-gray-100 ">
                                    ...
                                    <td className="py-4 text-sm font-medium text-gray-400 whitespace-nowrap line-through">Yann HABIE</td>
                                    <td className="py-4 text-sm font-medium text-gray-400 whitespace-nowrap line-through">yann@easyscooter.com</td>
                                    <td className="py-4 text-sm font-medium text-gray-400 whitespace-nowrap ">Customer</td>
                                    <td className="py-4 text-sm font-medium text-gray-400 whitespace-nowrap ">17/05/2022 18:02</td>
                                    <td className="py-4 text-sm font-medium text-gray-400 whitespace-nowrap ">
