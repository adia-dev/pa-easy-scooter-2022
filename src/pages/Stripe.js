  ...
  return (
    <div className='bg-gray-200 w-screen h-screen justify-center items-center p-3'>
      <div className="w-4/12 bg-white h-full mx-auto rounded-xl p-5 relative overflow-hidden">
        ...
        <span className="text-gray-500">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Porro repellendus dolorem ipsum labore omnis autem modi dignissimos, assumenda delectus hic.</span>

        <div className="w-full border-b py-5 mb-3"></div>

        <h1 className="mt-5 font-semibold mb-3">Moyen de paiement: CB</h1>
        <span className="text-gray-500">Veuillez entrer vos informations bancaires</span>
        <form className="w-full space-y-3">
          <input className="w-full border-gray-200 rounded-xl" type="text" placeholder="💳   Card Number" />
          <div className="flex items-center justify-between py-3">
            <input className="border-gray-200 rounded-lg" type="date" name="date" id="date" />
            <input className="border-gray-200 rounded-lg" type="text" name="cvc" id="cvc" placeholder="CVC" />
          </div>
          <span className="font-semibold cursor-pointer text-blue-500 text-sm ">Plus de moyens de paiements</span>
        </form>
