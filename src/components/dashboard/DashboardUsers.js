...
const DashboardUsers = () => {
    return (
        <div className='w-[80%] h-full relative left-[19%]'>

            <header className='w-full bg-gray-100 px-8 py-5 mb-5'>
                <div className="flex items-center h-full font-semibold text-3xl">
                    <h1>Users</h1>
                </div>

                <div className="flex items-center space-x-2 mt-5 bg-gray-100 w-fit px-3 py-1 rounded-full">
            ...
            <div className="flex items justify-around p-5">
                <div className="w-[300px] h-[150px] bg-gray-100 flex items-center justify-center rounded-lg">
                    <div className="flex items-center space-x-5">
                        <FaUsers size={48} color='green' />
                ...
                <div className="w-[300px] h-[150px] bg-gray-100 flex items-center justify-center rounded-lg">
                    <div className="flex items-center space-x-5">
                        <GiKickScooter size={48} color='blue' />
                        <div className="flex flex-col">
                            <span className='font-bold text-2xl'>300</span>
                            <span className='text-gray-400'>Scooters Available</span>
                        </div>
                    </div>
                </div>
                <div className="w-[300px] h-[150px] bg-gray-100 flex items-center justify-center rounded-lg">
                    <div className="flex items-center space-x-5">
                        <FaShoppingCart size={48} color='orange' />
                        <div className="flex flex-col">
                        ...
                        <table class="w-full whitespace-nowrap">
                            <tbody>
                                <tr tabindex="0" class="focus:outline-none h-16 border border-gray-100 rounded">
                                    ...
                                    <td class="pl-4">
                                        <button class="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-gray-600 py-3 px-5 bg-gray-100 rounded hover:bg-gray-200 focus:outline-none">Profile</button>
                                    </td>
                                    <td class="pl-4">
                                        <button class="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-gray-600 py-3 px-5 bg-blue-100 rounded hover:bg-gray-200 focus:outline-none">Book</button>
                                    </td>
                                    <td class="pl-4">
                                        <button class="focus:ring-2 focus:ring-offset-2 focus:ring-red-300 text-sm leading-none text-gray-600 py-3 px-5 bg-red-100 rounded hover:bg-gray-200 focus:outline-none">Delete</button>
                                    </td>
                                    {/* <td>
